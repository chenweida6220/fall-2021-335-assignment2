/*
  Name: Wei Da Chen
  Date: 10/11/2021
	Header file: avl_tree.h
*/

/*
This file includes the AvlTree class which consists of a self-balancing AVL tree
along with functions to access/modify the data of the tree.
*/
