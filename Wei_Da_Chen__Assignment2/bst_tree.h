/*
  Name: Wei Da Chen
  Date: 10/11/2021
	Header file: bst_tree.h
*/

/*
This file includes the BinarySearchTree class and its basic functions to
access/modify the data of the tree.
*/
...
class BinarySearchTree
{
  ...
  private:
    ...
    void getSeq(const string & x, BinaryNode *t) const{
        if(t == nullptr){
            cout << "Not Found" << endl;
        }
...
*****************************************************/
    ...
    int depthOfTree_helper(BinaryNode *t, int depth)
	{
        if (t == nullptr)
            return 0;
        else
    ...
    void printer( const Comparable &x, BinaryNode *t ) {
        if( t == nullptr )
            return;
        else if( x < t->element )
